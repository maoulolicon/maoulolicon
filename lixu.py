...
>--------------------------------------------->
Version 4.7.1 (2023/11/22)
                              C0d3d by L330n123
			      and some minor changes by maoulolicon
┌─────────────────────────────────────────────┐
│        Tos: Don't attack .gov website       │
├─────────────────────────────────────────────┤
│                   Donate:                   │
│          [+] MBBank/Zalo   │
│          [+] 26020062006/0866833274                     │
├─────────────────────────────────────────────┤
│ Link: https://github.com/maoulolicon/lixu-ddos/    │
└─────────────────────────────────────────────┘''')
...
def main():
	...
	build_threads(mode,thread_num,event#!/usr/bin/python3
#Coded by L330n123
#########################################
#         Just a little change          #
#                           -- L330n123 #
...
├─────────────────────────────────────────────┤
│                   Donate:                   │
│          [+] Momo/ZaloPay/MBBank/CakeBank   │
│          [+] 0363608641                     │
├─────────────────────────────────────────────┤
│ Link: https://github.com/ndbiaw/cc-ddos/    │
└─────────────────────────────────────────────┘''')
...
if __name__ == "__main__":
	main()#Coded by Leeon123,proxy_type)
	event.clear()
	#input("Press Enter to continue.")
	event.set()
	print("> Flooding...")
